...
4. Flag anti-patterns: brochure openings, walls of text, missing critique, legacy `C:` / `P1:` prefix lines.
...
- **Avoid** — specific phrases or structures to drop in the draft
