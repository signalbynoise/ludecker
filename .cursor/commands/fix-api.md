...
AAAC: `/fix-api <domain> "<intent>"`

**Layer:** product  
**Repair something broken** a **integration** (alias `fix-api` → `fix-integration`) — API, endpoint, webhook, MCP, or external adapter.

## Dispatch

1. [.cursor/aaac/dispatch.md](../aaac/dispatch.md)
2. [.cursor/aaac/graph.yaml](../aaac/graph.yaml) — **`fix-api`**
