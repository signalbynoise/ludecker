...
AAAC: `/update-doc <domain> "<intent>"`

**Layer:** system  
**Modify existing thing** a **architecture** (alias `update-doc` → `update-architecture`) — Boundaries, capabilities, architecture docs.

## Dispatch

1. [.cursor/aaac/dispatch.md](../aaac/dispatch.md)
2. [.cursor/aaac/graph.yaml](../aaac/graph.yaml) — **`update-doc`**
